...
Per soddisfare il caso d’uso, è stato creato un servizio di invio personalizzato per memorizzare i dati e gli allegati inviati in Azure. Quando viene inviato un modulo basato su un componente core, i dati sono nel formato seguente
...
[Scrivi configurazione OSGi](./create-osgi-configuration.md)
