...
* Scarica e installa la [libreria client e le immagini di esempio](assets/InlineDAMImage.zip) nella tua istanza di AEM utilizzando Gestione pacchetti di AEM.
* Scarica e installa il [modulo di esempio](assets/FieldInspectionForm.zip) nella tua istanza di AEM utilizzando Gestione pacchetti di AEM.
