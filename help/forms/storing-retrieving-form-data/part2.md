...
# Creare un servlet per memorizzare i dati del modulo

Il passo successivo consiste nel creare un servlet che inserisca o aggiorni i dati del modulo. Alla riga 26 viene fatto riferimento alla DataSource del pool di connessioni Apache Sling Connection configurata nel passaggio precedente. Il resto del codice è abbastanza semplice. Il codice inserisce una nuova riga nel database o aggiorna una riga esistente. I dati del modulo adattivo memorizzati sono associati a un GUID. Lo stesso GUID viene quindi utilizzato per aggiornare i dati del modulo.
