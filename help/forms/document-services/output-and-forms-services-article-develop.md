...
Il seguente frammento di codice esporta i dati da un file PDF
...
[Scaricare e installare il pacchetto utilizzando Gestione pacchetti di AEM](assets/using-output-and-form-service-api.zip)
