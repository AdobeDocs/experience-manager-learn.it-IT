...
## Servlet di authoring di AEM

Il passaggio successivo consiste nell’archiviare i dati inviati nell’archivio di AEM Author. Il servlet montato su `/bin/startworkflow` salva i dati inviati.
