...
Scopri come rendere i siti web veloci con Edge Delivery

Rivedi [documentazione](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/edge-delivery/overview.html) per informazioni complete sulla distribuzione di Edge e sulle relative funzionalità.
...
<div class="columns is-multiline">
    ...
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen"
      ...
      <div class="card">
        <div class="card-image">
          <figure class="image is-16by9">
            <a href="./developing/prerequisites.md" title="Installa nodo"
              tabindex="-1">
              <img class="is-bordered-r-small"
        ...
        <div class="card-content is-padded-small">
          <div class="content">
            ...
            <p class="headline is-size-6 has-text-weight-bold">
              <a href="./developing/prerequisites.md" title="Installa nodo">Installa nodo</a>
            </p>
            <p class="is-size-6">Breve panoramica su come installare Node JS.</p>
            <a href="./developing/prerequisites.md" class="spectrum-Button
              spectrum-Button--outline spectrum-Button--primary
              spectrum-Button--sizeM">
              <span class="spectrum-Button-label has-no-wrap
