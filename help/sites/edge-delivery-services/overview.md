...
<div class="columns is-multiline">
      ...
      <div class="card">
        <div class="card-image">
          <figure class="image is-16by9">
            <a href="https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/edge-delivery/build/tutorial" title="Tutorial sul sito web di authoring basato su documenti"
              tabindex="-1">
              <img class="is-bordered-r-small"
                src="./assets/overview/document-based-authoring-tutorial.png"
                alt="Tutorial sul sito web di authoring basato su documenti">
            </a>
          </figure>
        </div>
        <div class="card-content is-padded-small">
          <div class="content">
            <p class="headline is-size-6 has-text-weight-bold">
              <a href="https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/edge-delivery/build/tutorial" title="Tutorial sul sito web di authoring basato su documenti">Tutorial sul sito Web di authoring basato su documenti</a>
            </p>
            ...
            <a href="https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/edge-delivery/build/tutorial" class="spectrum-Button
              ...
              <span class="spectrum-Button-label has-no-wrap
                has-text-weight-bold">Avvia l'esercitazione</span>
            </a>
          </div>
        </div>
      </div>
    ...
    <div class="column is-half-tablet is-half-desktop is-one-half-widescreen"
      ...
      <div class="card">
        <div class="card-image">
          <figure class="image is-16by9">
            <a href="https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/edge-delivery/wysiwyg-authoring/edge-dev-getting-started" title="Tutorial sul sito Web di Universal Editor"
              tabindex="-1">
              <img class="is-bordered-r-small"
                src="./assets/overview/universal-editor-tutorial.png"
                alt="Tutorial sul sito Web di Universal Editor">
            </a>
          </figure>
        </div>
        <div class="card-content is-padded-small">
          <div class="content">
            <p class="headline is-size-6 has-text-weight-bold">
              <a href="https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/edge-delivery/wysiwyg-authoring/edge-dev-getting-started" title="Tutorial sul sito Web di Universal Editor">Tutorial sul sito Web di Universal Editor</a>
            </p>
            <p class="is-size-6">Scopri come creare siti web di Edge Delivery Services creati con Universal Editor.</p>
