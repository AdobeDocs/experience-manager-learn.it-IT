...
+ Playlist dei video{#video-playlists}
   + [Vista risorse](playlists/assets-view.md)
   + [Vista amministratore](playlists/admin-view.md)

+ Configurazione{#configuring}
   + [Cartelle della linea di base](configuring/baseline-folders.md)
   + [Autorizzazioni della linea di base](configuring/baseline-permissions.md)
   + [Assegnazione tag](configuring/tagging.md)
   + [Schemi di metadati](configuring/metadata-schemas.md)
   + [Profili di metadati](configuring/metadata-profiles.md)
   + [Schemi di cartelle di metadati](configuring/metadata-folder-schemas.md)
   + [Barra di ricerca di amministrazione risorse](configuring/assets-admin-search-rail.md)
...
+ Authoring{#authoring}
   + [Cambiare la vista](./authoring/switch-views.md)
   ...
   + [Correlate e non correlate](./authoring/relate-unrelate.md)
...
+ Ricerca e individuazione{#search-and-discovery}
   ...
   + [Integrazione di Adobe Firefly](./search-and-discovery/adobe-firefly.md)
   + [Raccolte](./search-and-discovery/collections.md)
   + [Incremento della ricerca](./search-and-discovery/search-boost.md)
   + [Trovare immagini simili](./search-and-discovery/find-similar-images.md)
...
+ Funzionalità avanzate{#advanced}
   ...
   + [Rapporti delle risorse](./advanced/asset-reports.md)
   + [Content credentials](./advanced/content-credentials.md)
   + [Tag bloccati](./advanced/blocked-tags.md)
   + [Estrarre l’archivio](./advanced/extract-archive.md)
...
+ Content Hub{#content-hub}
   ...
   + [Configurare](./content-hub/configure.md)
   + [Aggiungere le risorse](./content-hub/add-assets.md)
   + [Scaricare le risorse](./content-hub/download-assets.md)
   + [Varianti di immagini utilizzando Adobe Express](./content-hub/image-variants.md)
   + [Raccolte](./content-hub/collections.md)
   + [Condivisione](./content-hub/share.md)
   + [Controllo degli accessi basato su attributi](./content-hub/attribute-based-access-control.md)
   + Casi d’uso{#use-cases}
      + [Gestire le risorse](./content-hub/use-cases/manage-assets.md)

+ Edge Delivery Services{#edge-delivery-services}
   + [Plug-in di Sidekick](./edge-delivery-services/sidekick-plugin.md)
...
+ Condivisione e distribuzione{#sharing}
   ...
   + Brand Portal{#brand-portal}
      ...
      + [Abilitare il download delle rappresentazioni](brand-portal/enable-renditions-download.md)
   ...
   + Condivisione risorse{#assets-share}
      ...
      + [Stile dei temi di Asset Share Commons](./sharing/asset-share-commons-feature-video-theming.md)
...
+ Adobe Asset Link{#adobe-asset-link}
   ...
   + [Accesso ad Adobe Asset Link](./adobe-asset-link/launch-adobe-asset-link.md)
   ...
   + [Inserire una copia](./adobe-asset-link/place-copy.md)
   + [Posizionamento collegato](./adobe-asset-link/place-linked.md)
   + [Solo per i posizionamenti (FPO)](./adobe-asset-link/for-placement-only.md)
   + [Ricercare le risorse](./adobe-asset-link/asset-search.md)
...
+ Dynamic Media{#dynamic-media}
   ...
   + Immagini {#images}
      + [Sintassi URL e predefiniti immagine](dynamic-media/dynamic-media-urls-and-image-presets.md)
   ...
   + Video {#video}
      + [Best practice](dynamic-media/dynamic-media-video-best-practices.md)
      ...
      + [Video su ritaglio avanzato di Dynamic Media](dynamic-media/dynamic-media-smart-crop-video.md)
   ...
   + Tutorial {#tutorials}
      ...
      + [Generazione di URL e codici incorporati](dynamic-media/tutorials/how-to-generate-public-url-or-embed-code-for-an-asset.md)
...
+ Integrazione di Workfront{#workfront}
   + Connettore avanzato{#enhanced-connector}
      + [Nozioni di base sul connettore avanzato](./workfront/enhanced-connector/basics.md)
      + [Cartelle progetto](./workfront/enhanced-connector/project-folders.md)
      + Serie AEM Experts{#aem-experts-series}
...
+ Traduzione {#translation}
   + [Traduzione del file di origine](translation/source-file-translation-feature-video-use.md)

+ Modelli per risorse{#asset-templates}
   + [Informazioni sui modelli per risorse](asset-templates/asset-templates-tutorial-understand.md)
   + [Utilizzo dei modelli per risorse](asset-templates/asset-templates-feature-video-use.md)
   + [Configurare i modelli per le risorse](asset-templates/asset-templates-technical-video-setup.md)
   + [Utilizzo dei cataloghi per le risorse](asset-templates/asset-catalog-template-feature-video-use.md)

+ Distribuzione{#deployment}
   + [Più tenant e sviluppo simultaneo](deployment/multitenancy-concurrent-article-understand.md)

+ [Assets Essentials](https://experienceleague.adobe.com/it/docs/experience-manager-learn/assets-essentials/overview){target=_blank}
