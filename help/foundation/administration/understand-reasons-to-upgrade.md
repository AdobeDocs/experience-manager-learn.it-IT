...
+ [Note sulla versione di AEM Foundation](https://helpx.adobe.com/it/experience-manager/6-5/release-notes/wcm-platform.html)
...
<table>
    ...
    <tbody>
        ...
        <tr>
            <td><strong><a href="https://helpx.adobe.com/it/experience-manager/6-5/sites/deploying/using/indexing-via-the-oak-run-jar.html">Supporto indice oak-run.jar</a>:</strong> Miglioramento della reindicizzazione, della raccolta delle statistiche e della verifica di coerenza degli indici Oak.</td>
            <td> </td>
            <td> </td>
            <td> </td>
            <td> </td>
        ...
        <tr>
            <td><strong><a href="https://helpx.adobe.com/it/experience-manager/6-5/sites/deploying/using/queries-and-indexing.html" target="_blank">Indici di ricerca personalizzati</a>: </strong>
        ...
        <tr>
            <td><strong><a href="https://helpx.adobe.com/it/experience-manager/6-5/sites/deploying/using/revision-cleanup.html" target="_blank">Pulizia revisioni in linea</a>:</strong>
        ...
        <tr>
            <td><strong><a href="https://helpx.adobe.com/it/experience-manager/6-5/sites/deploying/using/storage-elements-in-aem-6.html" target="_blank">Archiviazione archivio TarMK o MongoMK</a>:</strong>
        ...
        <tr>
            <td><strong><a href="https://helpx.adobe.com/it/experience-manager/6-5/sites/deploying/using/aem-with-mongodb.html" target="_blank">Prestazioni e stabilità MongoMK</a>:</strong>
        ...
        <tr>
            <td><strong><a href="https://helpx.adobe.com/it/experience-manager/6-5/sites/deploying/using/data-store-config.html#AmazonS3DataStore">Archivio dati Amazon S3</a>:</strong>
        ...
        <tr>
            <td><strong><a href="https://helpx.adobe.com/it/experience-manager/6-5/sites/administering/using/operations-dashboard.html" target="_blank">Dashboard operazioni</a>:</strong>
 Esegui la manutenzione, monitora lo stato del server e analizza le prestazioni dall’interno di AEM.</td>
        ...
        <tr>
            <td><strong><a href="https://helpx.adobe.com/it/experience-manager/6-5/sites/deploying/using/upgrade.html" target="_blank">Miglioramenti all'aggiornamento</a>:</strong>
...
+ [Note sulla versione di sicurezza](https://helpx.adobe.com/it/experience-manager/6-5/release-notes/wcm-platform.html#Security)

***✔ indica che in questa versione sono stati apportati miglioramenti significativi alla funzionalità.***
...
<table>
    ...
    <tbody>
        <tr>
        <td><strong><a href="https://helpx.adobe.com/it/experience-manager/6-5/sites/administering/using/security-service-users.html" target="_blank">Utenti del servizio</a></strong>
    ...
    <tr>
        <td><a href="https://helpx.adobe.com/it/experience-manager/6-5/sites/developing/using/csrf-protection.html" target="_blank"><strong>CSRF</strong> <strong>protezione</strong></a>
    ...
    <tr>
        <td><strong><a href="https://experienceleague.adobe.com/docs/?lang=it" target="_blank">Supporto dell'autenticazione SAML migliorato</a><br>
    ...
    <tr>
        <td><strong><a href="https://helpx.adobe.com/it/experience-manager/6-5/sites/administering/using/ldap-config.html" target="_blank">LDAP come configurazione OSGi</a><br>
    ...
    <tr>
        <td><strong><a href="https://helpx.adobe.com/it/experience-manager/6-5/sites/administering/using/user-group-ac-admin.html" target="_blank">Miglioramenti CUG</a><br>
    ...
    <tr>
        <td><strong><a href="https://helpx.adobe.com/it/experience-manager/6-5/sites/administering/using/encapsulated-token.html" target="_blank">Supporto token incapsulato</a></strong>
    ...
    <tr>
        <td><strong><a href="https://helpx.adobe.com/it/experience-manager/6-5/sites/administering/using/ims-config-and-admin-console.html" target="_blank">Supporto per l'autenticazione Adobe IMS</a><br>
...
+ [Note sulla versione di AEM Sites](https://helpx.adobe.com/it/experience-manager/6-5/release-notes/sites.html)
...
<table>
    ...
    <tbody>
        ...
        <tr>
            <td><strong><a href="https://helpx.adobe.com/it/experience-manager/6-5/sites/authoring/using/responsive-layout.html" target="_blank">Authoring reattivo del sito</a>:</strong>
        ...
        <tr>
            <td><strong><a href="https://helpx.adobe.com/it/experience-manager/core-components/user-guide.html" target="_blank">Componenti core</a>:</strong>
        ...
        <tr>
            <td><strong><a href="https://helpx.adobe.com/it/experience-manager/6-5/sites/developing/using/spa-overview.html" target="_blank">Editor SPA</a>:</strong>
        ...
        <tr>
            <td><strong><a href="https://helpx.adobe.com/it/experience-manager/6-5/sites/administering/using/translation.html" target="_blank">Traduzione contenuto</a>:</strong>
        ...
        <tr>
            <td><strong><a href="https://helpx.adobe.com/it/experience-manager/6-5/sites/developing/using/contexthub.html" target="_blank">ContextHub</a>:</strong>
        ...
        <tr>
            <td><strong><a href="https://helpx.adobe.com/it/experience-manager/6-5/sites/authoring/using/launches.html" target="_blank">Avvii</a>:</strong>
        ...
        <tr>
            <td><strong><a href="https://helpx.adobe.com/it/experience-manager/6-5/sites/authoring/using/content-targeting-touch.html" target="_blank">Integrazione Adobe Target</a>:</strong>
        ...
        <tr>
            <td><strong><a href="https://helpx.adobe.com/it/experience-manager/6-5/sites/administering/using/campaign.html" target="_blank">Integrazione Adobe Campaign</a>:</strong>
        ...
        <tr>
            <td><strong><a href="https://helpx.adobe.com/it/experience-manager/6-5/sites/administering/using/ecommerce.html" target="_blank">eCommerce</a>:</strong>
        ...
        <tr>
            <td><strong><a href="https://helpx.adobe.com/it/experience-manager/6-5/communities/using/overview.html" target="_blank">Community</a>:</strong>
...
+ [Note sulla versione di AEM Assets](https://helpx.adobe.com/it/experience-manager/6-5/release-notes/assets.html)
...
<table>
    ...
    <tbody>
        <tr>
            <td><strong><a href="https://helpx.adobe.com/it/experience-manager/6-5/assets/using/managing-assets-touch-ui.html" target="_blank">Interfaccia utente ottimizzata per il tocco</a>:</strong>
        ...
        <tr>
            <td><strong><a href="https://helpx.adobe.com/it/experience-manager/6-5/assets/using/metadata.html" target="_blank">Gestione avanzata dei metadati</a>:</strong>
        ...
        <tr>
            <td><strong><a href="https://helpx.adobe.com/it/experience-manager/6-5/sites/authoring/using/task-content.html" target="_blank">Attività</a> e Gestione flussi di lavoro:</strong>
        ...
        <tr>
            <td><strong><a href="https://helpx.adobe.com/it/experience-manager/6-5/assets/using/mac-api-assets.html" target="_blank">API HTTP Assets</a>:</strong>
        ...
        <tr>
            <td><strong><a href="https://helpx.adobe.com/it/experience-manager/6-5/assets/using/link-sharing.html" target="_blank">Condivisione collegamenti</a>:</strong>
        ...
        <tr>
            <td><strong><a href="https://helpx.adobe.com/it/experience-manager/brand-portal/using/brand-portal.html" target="_blank">Brand Portal</a>:</strong>
        ...
        <tr>
            <td><strong><a href="https://helpx.adobe.com/it/experience-manager/6-5/assets/using/use-assets-across-connected-assets-instances.html" target="_blank">Assets connesso</a>:</strong>
        ...
        <tr>
            <td><strong><a href="https://helpx.adobe.com/it/experience-manager/6-5/assets/using/touch-ui-asset-insights.html" target="_blank">Informazioni sulla risorsa</a>:</strong>
        ...
        <tr>
            <td><strong><a href="https://helpx.adobe.com/it/experience-manager/6-5/assets/using/multilingual-assets.html" target="_blank">Assets multilingue</a>:</strong>
        ...
        <tr>
            <td><strong><a href="https://helpx.adobe.com/it/experience-manager/6-5/assets/using/enhanced-smart-tags.html" target="_blank">Tag avanzati e moderazione</a>:</strong>
        ...
        <tr>
            <td><strong><a href="https://helpx.adobe.com/it/experience-manager/6-5/assets/using/indesign.html" target="_blank">Integrazione Adobe InDesign Server</a>:</strong>
        ...
        <tr>
            <td><strong><a href="https://helpx.adobe.com/it/experience-manager/6-5/assets/using/imaging-transcoding-library.html" target="_blank">Libreria di imaging Adobe</a>:</strong>
        ...
        <tr>
            <td><strong><a href="https://helpx.adobe.com/it/experience-manager/6-5/assets/using/aem-assets-adobe-stock.html" target="_blank">Integrazione Adobe Stock</a>:</strong>
...
<table>
    ...
    <tbody>
        <tr>
            <td><strong><a href="https://helpx.adobe.com/it/experience-manager/6-5/assets/using/managing-assets.html" target="_blank">Immagini</a>:</strong>
        ...
        <tr>
            <td><strong><a href="https://helpx.adobe.com/it/experience-manager/6-5/assets/using/video-profiles.html" target="_blank">Video</a>:</strong>
        ...
        <tr>
            <td><strong><a href="https://helpx.adobe.com/it/experience-manager/6-5/assets/using/interactive-images.html" target="_blank">File multimediali interattivi</a>:</strong>
        ...
        <tr>
            <td><strong>Set (<a href="https://helpx.adobe.com/it/experience-manager/6-5/assets/using/image-sets.html" target="_blank">Immagine</a>, <a href="https://helpx.adobe.com/it/experience-manager/6-5/assets/using/spin-sets.html" target="_blank">Rotazione</a>, <a href="https://helpx.adobe.com/it/experience-manager/6-5/assets/using/mixed-media-sets.html" target="_blank">File Multimediali Misti</a>):</strong>
        ...
        <tr>
            <td><strong><a href="https://experienceleague.adobe.com/docs/?lang=it" target="_blank">Visualizzatori</a>:</strong>
        ...
        <tr>
            <td><strong><a href="https://helpx.adobe.com/it/experience-manager/6-5/assets/using/delivering-dynamic-media-assets.html" target="_blank">Consegna</a>:</strong>
...
<table>
    ...
    <tbody>
        <tr>
            <td><strong><a href="https://helpx.adobe.com/it/experience-manager/6-5/forms/using/introduction-forms-authoring.html" target="_blank">Editor Forms adattivo</a>:</strong>
        ...
        <tr>
            <td><strong><a href="https://helpx.adobe.com/it/experience-manager/6-5/forms/using/generate-document-of-record-for-non-xfa-based-adaptive-forms.html" target="_blank">Documento record</a>:</strong>
        ...
        <tr>
            <td><strong><a href="https://helpx.adobe.com/it/experience-manager/6-5/forms/using/themes.html" target="_blank">Editor temi</a>:</strong>
        ...
        <tr>
            <td><strong><a href="https://helpx.adobe.com/it/experience-manager/6-5/forms/using/template-editor.html" target="_blank">Editor modelli</a>:</strong>
        ...
        <tr>
            <td><strong><a href="https://helpx.adobe.com/it/aem-forms/6-5/whats-new.html#EnhancedintegrationwithAdobeSign" target="_blank">Integrazione Acrobat Sign</a>:</strong>
        ...
        <tr>
            <td><strong><a href="https://helpx.adobe.com/it/experience-manager/6-5/forms/using/cm-overview.html" target="_blank">Gestione della corrispondenza</a>:</strong>
        ...
        <tr>
            <td><strong><a href="https://helpx.adobe.com/it/aem-forms/6-5/whats-new.html#AEMFormsdataintegration" target="_blank">Integrazione dei dati di terze parti</a>:</strong>
        ...
        <tr>
            <td><strong><a href="https://helpx.adobe.com/it/aem-forms/6-5/whats-new.html#FormscentricAEMWorkflowsforAEMFormsonOSGi" target="_blank">Flusso di lavoro (su OSGi) per elaborazione Forms</a>:</strong>
        ...
        <tr>
            <td><strong><a href="https://helpx.adobe.com/it/experience-manager/6-5/forms/using/introduction-managing-forms.html" target="_blank">Gestione moduli</a>:</strong>
        ...
        <tr>
            <td><strong><a href="https://helpx.adobe.com/it/experience-manager/6-5/forms/using/aem-forms-app.html" target="_blank">App AEM Forms</a>:</strong>
        ...
        <tr>
            <td><strong><a href="https://helpx.adobe.com/it/aem-forms/6-5/adaptive-document.html" target="_blank">Comunicazioni interattive</a>:</strong>
        ...
        <tr>
            <td><strong><a href="https://helpx.adobe.com/it/aem-forms/6-5/whats-new.html#EnhancedDocumentSecurity" target="_blank">AEM Forms Document Security</a>:</strong>
        ...
        <tr>
            <td><strong><a href="https://helpx.adobe.com/it/aem-forms/6-5/whats-new.html#Simplifiedauthoringexperience" target="_blank">Framework di test</a>:</strong>
