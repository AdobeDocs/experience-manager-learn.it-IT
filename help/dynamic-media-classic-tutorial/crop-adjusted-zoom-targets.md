...
Per accedere allo strumento Ritaglia in Dynamic Media Classic, dalla pagina Dettagli di una risorsa o fate clic sul pulsante **Modifica** . Potete usare lo strumento per ritagliare in due modi:

- Modalità di ritaglio predefinita in cui si trascinano le maniglie della finestra di ritaglio o i valori del tipo nella casella Dimensioni. Scoprite come ritagliare [](https://docs.adobe.com/content/help/en/dynamic-media-classic/using/master-files/cropping-image.html#select-an-area-to-crop)manualmente.
...
>[!NOTE]
>
>L’opzione Rifila non crea trasparenza intorno all’immagine. A questo scopo, dovrete incorporare un tracciato di ritaglio nell’immagine e utilizzare l’opzione di caricamento **Crea maschera da tracciato** di ritaglio.
>
>Inoltre, per ripristinare lo stato originale di un’immagine dopo averla ritagliata quando avete usato l’opzione **Salva** , visualizzate l’immagine nella schermata Editor di ritaglio e fate clic sul pulsante **Ripristina** .
...
![modificatori del comando image](assets/crop-adjusted-zoom-targets/cropping-by-url.png)_Crop nella parte inferiore dell’Editor di ritaglio_
...
![image](assets/crop-adjusted-zoom-targets/cropping-in-image-preset.jpg)_Aggiungi comandi di ritaglio (o qualsiasi comando) ai modificatori URL del predefinito per immagini._
...
Quando usate lo strumento taglierina, potete scegliere **Salva come visualizzazione aggiuntiva della pagina master**. Una volta salvati, verrà creato un nuovo tipo di risorsa Dynamic Media Classic — un’immagine regolata. Un’immagine regolata, detta anche derivata, è un’immagine virtuale. Non è affatto un&#39;immagine; è un riferimento al database (come un alias o una scelta rapida) all&#39;immagine principale fisica.

### L&#39;immagine vera per favore si alza`?`
...
Scoprite come [creare destinazioni](https://docs.adobe.com/content/help/en/dynamic-media-classic/using/zoom/creating-zoom-targets-guided-zoom.html#creating-and-editing-zoom-targets)di zoom.
...
1. Passate all’immagine, fate clic sul pulsante **Modifica** e scegliete Destinazioni **di** zoom.
...
3. Spostate la casella rossa con il mouse e fate clic per creare una nuova destinazione.
   ...
   - La dimensione di destinazione è determinata dalla dimensione della visualizzazione all’interno del predefinito per visualizzatori. Questo determina la dimensione dell’immagine di zoom principale. Consultate _Impostazione delle dimensioni_ di visualizzazione, di seguito.
...
7. Inoltre, per rimuovere una destinazione, selezionatela facendo clic sulla relativa miniatura, quindi premete il pulsante **Elimina destinazione** o il tasto DELETE sulla tastiera.
8. Continuate a fare clic per aggiungere nuove destinazioni, rinominare e/o ridimensionare dopo l’aggiunta.
9. Al termine, fate clic sul pulsante **Salva** , quindi su **Anteprima**.
