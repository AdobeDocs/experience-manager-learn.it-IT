...
breadcrumb-title: Integrazioni Experience Cloud
...
+ Integrazioni di applicazioni{#integrations-between-applications}
   ...
   + Experience Platform{#experience-platform}
      + [Analytics](./integrations-between-applications/experience-platform/experience-platform-analytics.md)
...
+ Tutorial{#tutorials}
   + Analytics ed Commerce{#analytics-commerce}
      + [Analytics ed Commerce](./tutorials/analytics-commerce/analytics-commerce.md)
   + Analytics e CJA{#analytics-cja}
      + [Analytics e CJA](./tutorials/analytics-customer-journey-analytics/experience-platform-source-connector.md)
   + Analytics e Real-Time CDP{#analytics-real-time-cdp}
      + [Analytics e Real-Time CDP](./tutorials/analytics-real-time-cdp/experience-platform-source-connector.md)
   + Analytics e Target{#analytics-target}
      + [Analytics e Target](./tutorials/analytics-target/analytics-target.md)
   + Campaign e Real-Time CDP{#campaign-real-time-cdp}
      + [Campaign v8 e Real-Time CDP](./tutorials/campaign-real-time-cdp/campaign-v8-real-time-cdp.md)
   + Real-Team CDP{#real-time-cdp-target}
      + [Real-Time CDP e Target](./tutorials/real-time-cdp-target/web-sdk-and-target-destination.md)