...
Si consiglia inoltre di rivedere l’ [Librerie lato client e l’esercitazione Flusso di lavoro front-end](client-side-libraries.md) per comprendere i fondamenti delle librerie lato client e i vari strumenti front-end incorporati nel progetto AEM.
...
1. Scopri come utilizzare il sistema di stili per applicare CSS specifici per il marchio ai componenti core di AEM.
...
Ora è necessario aggiungere un nuovo criterio per i componenti Titolo per consentire agli autori di contenuti di scegliere lo stile Sottolineato da applicare a componenti specifici. Questa operazione viene eseguita utilizzando l’Editor modelli di AEM.
...
### Ispeziona testo componente markup
...
Congratulazioni, la pagina dell’articolo è quasi completamente formattata e hai acquisito un’esperienza pratica utilizzando il sistema di stili di AEM.
