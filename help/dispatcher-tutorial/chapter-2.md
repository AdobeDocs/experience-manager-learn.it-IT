---
title: "Capitolo 2 - Infrastruttura di Dispatcher"
...
![Configurazione di Dispatcher &quot;legacy&quot;: non molto comune secondo gli standard attuali](assets/chapter-2/legacy-dispatcher-setup.png)
...
![Configurazione moderna di Dispatcher standard: facilità di gestione e manutenzione](assets/chapter-2/modern-standard-dispatcher-setup.png)
...
![Configurazione &quot;Scalabilità orizzontale&quot;: presenta alcune aree di applicazione, ma anche limitazioni e avvertenze](assets/chapter-2/scale-out-setup.png)
...
Se sei anche preoccupato per la latenza di un visitatore, puoi utilizzare una rete di distribuzione dei contenuti, recuperare la cache in anticipo, scaldare la cache in anticipo, impostando un tempo di tolleranza come descritto in [Capitolo 1](chapter-1.md) o fare riferimento ad alcune idee avanzate di [Parte 3](chapter-3.md).
