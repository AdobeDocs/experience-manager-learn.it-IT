---
title: Connessioni HTTP/HTTPS su porte non standard
description: Scopri come effettuare richieste HTTP/HTTPS da AEM as a Cloud Service a servizi Web esterni in esecuzione su porte non standard.
...
# Connessioni HTTP/HTTPS su porte non standard
