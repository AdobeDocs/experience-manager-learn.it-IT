...
description: Panoramica generale sul caching dei servizi AEM as a Cloud Service Publish.
...
![Diagramma panoramica sulla memorizzazione nella cache di Publish per AEM](./assets/publish/publish-all.png){align="center"}
...
![CDN Publish AEM](./assets/publish/publish-cdn.png){align="center"}
...
Se una risposta HTTP è idonea per il caching di Dispatcher AEM [per qualificatori superiori](#when-are-http-requestsresponses-cached), i valori predefiniti sono i seguenti, a meno che non sia presente una configurazione personalizzata.
...
Se una risposta HTTP è idonea per il caching di Dispatcher AEM [per qualificatori superiori](#when-are-http-requestsresponses-cached-1), i valori predefiniti sono i seguenti, a meno che non sia presente una configurazione personalizzata.
...
La cache del Dispatcher AEM può essere configurata tramite la [configurazione Dispatcher](https://experienceleague.adobe.com/docs/experience-manager-dispatcher/using/configuring/dispatcher-configuration.html?lang=en#configuring-the-dispatcher-cache-cache) che include:
