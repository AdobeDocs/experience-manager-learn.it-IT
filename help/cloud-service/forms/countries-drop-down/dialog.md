---
title: Creare il dialogo per il componente Paesi
description: Creare la finestra di dialogo per il componente
...
# Creare la finestra di dialogo per il componente Paesi

Il componente Paesi eredita la struttura di dialogo del componente a discesa, ma introduce una nuova proprietà denominata continente. Inoltre, la finestra di dialogo viene personalizzata per nascondere alcuni campi ereditati dal componente a discesa, consentendo agli autori di selezionare il continente desiderato.

Il modo più semplice per creare questa finestra di dialogo è il seguente:

1. Nel progetto AEM, crea una cartella denominata _cq_dialog nella cartella del componente paesi.
2. All&#39;interno della cartella _cq_dialog, creare un file denominato content.xml.
3. Incolla nel file il codice XML fornito di seguito.
4. Salva le modifiche e sincronizza il progetto con AEM.

Verrà aggiunta la configurazione della finestra di dialogo per il componente Paesi.
...
[Crea un modello sling.](./slingmodel.md)
